...
export default async function ComptableDashboard() {
  ...
  const { data: frais } = await supabase
    ...
    .select(
      "id, eleve_id, annee_scolaire, montant_total, montant_paye, date_echeance"
    )
  ...
  const echeances = lignesFrais.filter(
    (ligne) =>
      Number(ligne.montant_total || 0) >
        Number(ligne.montant_paye || 0) &&
      ligne.date_echeance &&
  ...
  return (
    <main className="min-h-screen bg-neutral-50 p-4 sm:p-6 lg:p-8">
      <div className="mx-auto max-w-7xl">
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
            ...
            <div className="mb-6">
              ...
              <p className="mt-1 text-sm text-neutral-500">
                État du recouvrement des frais de scolarité.
              </p>
            </div>
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-5 grid gap-3">
              ...
              <ActionCard
                ...
                title="💳 Paiements"
                description="Accéder au suivi des règlements."
              />
        ...
        {/* DERNIÈRES SITUATIONS À SURVEILLER */}

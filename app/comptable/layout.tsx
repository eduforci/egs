...
const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [{ label: 'Accueil', href: '/comptable/dashboard', icon: '🏠' }],
  },
  {
    titre: 'FINANCES',
    items: [
      { label: 'Frais de scolarité', href: '/chef/comptabilite/frais', icon: '💰' },
      ...
      >
        ...
        <div className="p-3 border-t border-neutral-800 flex items-center gap-2">
          ...
          <div className="text-xs">
            ...
            <div className="text-neutral-400">Comptabilité</div>
          </div>
        </div>
      </aside>
